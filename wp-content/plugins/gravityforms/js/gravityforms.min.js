...
void 0 === jQuery.fn.prop && (jQuery.fn.prop = jQuery.fn.attr), jQuery(document).on("gform_post_render", gformBindFormatPricingFields), gform.instances = {}, gform.console = {
    error: function(e) {
...
function gformGetProductQuantity(e, t) {
    ...
    var r, i, n = jQuery("#ginput_quantity_" + e + "_" + t);
...
function gformGetBasePrice(e, t) {
    ...
    return 0 < r.length ? t = r.val() : (e = (r = jQuery(".gfield_product" + e + " select, .gfield_product" + e + " input:checked, .gfield_donation" + e + " select, .gfield_donation" + e + " input:checked")).val()) && (t = 1 < (e = e.split("|")).length ? e[1] : 0), gformIsHidden(r) && (t = 0), !1 === (t = new gform.Currency(gf_global.gf_currency_config).toNumber(t)) ? 0 : t
}
...
function gformFormatPricingField(e) {
    var t;
    gf_global.gf_currency_config && (t = new gform.Currency(gf_global.gf_currency_config).toMoney(jQuery(e).val()), jQuery(e).val(t))
}
...
function gformInitPriceFields() {
    gform.tools.getNodes(".gfield_price", !0, document, !0).forEach(e => {
        ...
        gformCalculateTotalPrice(e), gform.state.watch(e, ["products", "feeds"], gformHandleProductChange), bindProductChangeEvent()
    })
}
...
function gformToggleCheckboxes(e) {
    ...
    t = i ? e.checked : "boolean" == typeof(i = r.data("checked")) ? !i : !(1 === parseInt(i)), o.each(function() {
    ...
    }), gformToggleSelectAll(e, t ? "deselect" : "select"), wp.a11y.speak(t ? gf_field_checkbox.strings.selected : gf_field_checkbox.strings.deselected), a && a.runCalcs(n, a.formulaFields)
}
...
function gformAddRepeaterItem(e, t) {
    var r, i, n, e = jQuery(e);
    e.hasClass("gfield_icon_disabled") || (r = (e = e.closest(".gfield_repeater_item")).clone(), i = e.closest(".gfield_repeater_container"), n = r.find(":input:last").attr("tabindex"), r.find('input[type!="hidden"], select, textarea').attr("tabindex", n).not(":checkbox, :radio").each(function(e) {
        jQuery(this).attr("value") ? jQuery(this).val(jQuery(this).attr("value")) : jQuery(this).is("textarea") ? jQuery(this).val(this.innerHTML) : jQuery(this).val("")
    }), r.find(":checkbox, :radio").prop("checked", !1), r.find(".validation_message").remove(), r.find(".gform-datepicker.initialized").removeClass("initialized"), r = gform.applyFilters("gform_repeater_item_pre_add", r, e), e.after(r), r.children(".gfield_repeater_cell").each(function() {
        ...
        GFMergeTag.getMergeTagValue = function(e, t, r) {
            ...
            if (!1 === a) {
                switch (a = "", r) {
                    ...
                    case "qty":
                        if (n.hasClass("gfield_price")) return !1 === (f = gformGetProductQuantity(e, i)) || "" === f ? 0 : f
                }
                if (1 === (o = "checkbox" !== o.prop("type") && "radio" !== o.prop("type") ? o : o.filter(":checked")).length) {
                    if (!o.is("select") && "radio" !== o.prop("type") && "checkbox" !== o.prop("type") || "" !== r) void 0 === f && (f = o.val());
                    else if ((f = o.is("select") ? o.find("option:selected") : ("radio" === o.prop("type") && o.parent().hasClass("gchoice_button") ? o.parent().siblings(".gchoice_label").find("label") : o.next("label")).clone()).find("span").remove(), 1 === f.length) f = f.text();
                    else {
                        for (var s = [], c = 0; c < f.length; c++) s[c] = jQuery(f[c]).text();
                        f = s
                    }
                    a = jQuery.isArray(f) ? f.join(", ") : "string" == typeof f ? GFMergeTag.formatValue(f, r) : ""
                } else if (1 < o.length) {
                    for (var d, f = [], c = 0; c < o.length; c++) "checkbox" === o.prop("type") && "" === r ? ((d = jQuery(o[c]).next("label").clone()).find("span").remove(), f[c] = GFMergeTag.formatValue(d.text(), r), d.remove()) : f[c] = GFMergeTag.formatValue(jQuery(o[c]).val(), r);
                    a = f.join(", ")
                }
            }
            return a
    ...
    GFCalc = (new GFMergeTag, function(formId, formulaFields) {
        this.formId = formId, this.formulaFields = formulaFields, this.exprPatt = /^[0-9 -/*\(\)]+$/i, this.isCalculating = {}, this.init = function(e, t) {
            ...
            if (calcObj.exprPatt.test(expr)) {
                ...
                result = !1 !== formattedResult ? formattedResult : field.hasClass("gfield_price") || "currency" == numberFormat ? gformFormatMoney(result || 0, !0) : (decimalSeparator = ".", thousandSeparator = ",", "decimal_comma" == numberFormat && (decimalSeparator = ",", thousandSeparator = "."), gformFormatNumber(result, gform.utils.isNumber(formulaField.rounding) ? formulaField.rounding : -1, decimalSeparator, thousandSeparator)), result != previous_val && (field.hasClass("gfield_price") ? (jQuery("#input_" + formId + "_" + formulaField.field_id).text(result), formulaInput.val(result).trigger("change"), window.gform.utils.trigger({
                    event: "change",
                    el: formulaInput[0],
                    native: !0
            ...
            for (r in a.isCalculating[l] = !1, s) s.hasOwnProperty(r) && (i = s[r][1], n = parseInt(i, 10), "checkbox" == (n = jQuery("#field_" + t + "_" + n).find('input[name="input_' + i + '"], select[name="input_' + i + '"]')).prop("type") || "radio" == n.prop("type") ? (jQuery(n).click(function() {
                a.bindCalcEvent(i, e, t, 0)
            }), 0 < (o = n.closest(".gfield--type-image_choice .gchoice")).length && jQuery(o).click(function() {
                a.bindCalcEvent(i, e, t, 0)
...
gform.recaptcha = {
    renderRecaptcha: function() {
        jQuery(".ginput_recaptcha:not(.gform-initialized)").each(function() {
            var e = jQuery(this),
                ...
                r = (e.data("stoken") && (t.stoken = e.data("stoken")), gform.applyFilters("gform_recaptcha_callback", !1, e)),
    ...
    executeRecaptcha: async function(e, i) {
        return window.grecaptcha.execute(e), new Promise((t, e) => {
            let r = setInterval(() => {
    ...
    m(document).on("gform_post_render", function(e, t) {
        ...
        })() && (alert(_.currently_uploading), e.abort = !0), e), 8))
...
function gformInitSpinner(e, t, r = 0) {
    gformIsSpinnerInitialized || (gformIsSpinnerInitialized = !0, window.gform.utils.addFilter("gform/submission/pre_submission", e => (gformShowSpinner(e.form.dataset.formid, t), e), 3), document.addEventListener("gform/submission/submission_aborted", function(e) {
...
function gformShowSpinner(e, t) {
    ...
    t !== gform.applyFilters("gform_spinner_url", gf_global.spinnerUrl, e) ? gformAddSpinner(e, t) : gformInitializeSpinner(e, gform.applyFilters("gform_spinner_target_elem", jQuery("#gform_submit_button_" + e + ", #gform_wrapper_" + e + " .gform_next_button, #gform_send_resume_link_button_" + e), e))
}
