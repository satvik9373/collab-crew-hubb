  ...
  >(({ className, children }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "z-10 flex size-12 items-center justify-center rounded-full border-2 border-border hover:bg-purple-00 transition-all p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
          className,
        )}
      >
        {children}
      ...
      >
        <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg ">
          <div className="flex flex-col justify-center gap-2 ">
            ...
            <Circle ref={div1Ref} className="hover:bg-purple-600">
              <Icons.Instagram />
            </Circle>
            </a>
            <a href="https://wa.me/919589527979">
            <Circle ref={div2Ref} className="hover:bg-purple-600">
              <Icons.Whatsapp />
            </Circle>
            </a>
            <a href="https://www.facebook.com/p/Collab-crew-hub-61559233890129/">
            <Circle ref={div3Ref} className="hover:bg-purple-600">
            <Image
                src={"/logo/meta.svg"}
                width={10000}
                height={10000}
            ...
            <Circle ref={div4Ref} className="hover:bg-purple-600">
              <Icons.Linkedin />
            </Circle>
            </a>
            <a href="https://calendly.com/collabcrewhub-info/new-meeting">
            <Circle ref={div5Ref} className="hover:bg-purple-600">
              <Icons.Calendly />
            </Circle>
            </a>
          </div>
          ...
          <div className="flex flex-col justify-center">
            <Circle ref={div7Ref} className="bg-white hover:bg-purple-600">
              <Icons.user />
            </Circle>
          </div>
        </div>
