...
export default function Home() {
 ...
 -z-10 h-full w-full bg-[#fafafa]
  ...
  <a href="tel:919589527979" className="hidden">
    <button className="px-4 py-2 rounded-md flex items-center justify-center gap-x-3">
      +91-9589527979
    </button>
  </a>

  <Link
  href="https://wa.me/919589527979"
  className="
    py-3 
    px-6
    text-lg 
...
>
        ...
        <main className="md:flex items-center justify-center space-y-6 md:space-y-0 md:gap-x-20 xl:w-4/5 2xl:w-[68%] mx-auto px-6 md:px-0">
          ...
          <div className="flex flex-col gap-y-5 md:w-1/2">
            <h1 className="text-lg md:text-2xl ">
              &quot;We&apos;ve been working with Collab Crew Hub for over 1 year and
  ...
  <div className="xl:w-4/5 2xl:w-[68%] mx-auto flex flex-col md:flex-row justify-between items-center gap-y-3">
    <div className="flex flex-col items-start">
      ...
      <p className="text-left text-xl text-gray-500">info@collabcrewhub.com</p>
    </div>
